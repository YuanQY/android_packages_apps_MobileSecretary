...
public class MessageActivity extends TabActivity implements OnTabChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMBCR = null;
        mInterceptionRecordFormat = getString(R.string.interception_record_sms_format);
    ...
    private MyBroadCastReceiver mMBCR = null;
    ...
    private void returnMessage() {
        for (int i = 0; i != mListViewTab1.getCount(); i++) {
            if (mListViewTab1.getCheckedItemPositions().get(i)) {
                ...
                cv.put("address", mCursorTab1.getString(mCursorTab1
                        .getColumnIndex(DbAdapter.MESSAGE_RUBBISH_PHONE)));
                String rowContent = mCursorTab1.getString(mCursorTab1
                        .getColumnIndex(DbAdapter.MESSAGE_RUBBISH_CONTENT));
                ...
                do {
                    mArray[i] = String.format(mInterceptionRecordFormat,
                            mCursorTab1.getString(mCursorTab1
                                    .getColumnIndex(DbAdapter.MESSAGE_RUBBISH_PHONE)),
                            mCursorTab1.getString(mCursorTab1
                                    .getColumnIndex(DbAdapter.MESSAGE_RUBBISH_TIME)),
                            mCursorTab1.getString(mCursorTab1
                                    .getColumnIndex(DbAdapter.MESSAGE_RUBBISH_CONTENT)));
                    i++;
                } while (mCursorTab1.moveToNext());
            }
            ArrayAdapter<String> mAdapter = new ArrayAdapter<String>(MessageActivity.this,
            ...
            if (mCursorTab2.moveToFirst()) {
                do {
                    mArray[i] = mCursorTab2.getString(mCursorTab2
                            .getColumnIndex(DbAdapter.MESSAGE_FORBID_PHONE));
                    i++;
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (getTabHost().getCurrentTab() == 0) {
            if (mListViewTab1.getCount() > 0) {
                ...
                menu.add(0, MENU_RUBBISH_MULTIPLE, 0, R.string.clear).setIcon(
                        android.R.drawable.ic_menu_delete);
                menu.add(0, MENU_RUBBISH_BACK, 0, R.string.revert).setIcon(
                        android.R.drawable.ic_menu_rotate);
                menu.add(0, MENU_ADD_CANTACT, 0, R.string.add_contacts).setIcon(
            ...
            if (mListViewTab2.getCount() > 0) {
                ...
                menu.add(0, MENU_FORBID_DELETE, 0, R.string.delete).setIcon(
                        android.R.drawable.ic_menu_close_clear_cancel);
                menu.add(0, MENU_FORBID_MULTIPLE, 0, R.string.clear).setIcon(
                        android.R.drawable.ic_menu_delete);
            } else {
                menu.add(0, MENU_FORBID_ADD_FIRST, 0, R.string.add).setIcon(
                        android.R.drawable.ic_menu_add);
        ...
        switch (item.getItemId()) {
            ...
            case MENU_RUBBISH_DELETE:
                if (positionTab1 != -1) {
                    ...
                    delMarkItemData(mListViewTab1, mCursorTab1,
                            DbAdapter.MESSAGE_RUBBISH_TABLE_NAME);
                }
                initTab1Data();
                break;
    ...
    private void addForbidPhone(String phoneNumber) {
        ...
        new AlertDialog.Builder(MessageActivity.this).setTitle(R.string.black_list_title)
                .setView(mRL)
                .setPositiveButton(R.string.ok, new OnClickListener() {
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        if (mNewForbidPhone.length() < 3) {
                            Toast.makeText(MessageActivity.this, R.string.input_error,
                                    Toast.LENGTH_SHORT)
                                    .show();
                        } else {
                            ...
                            for (int i = 0; i != mStr.length; i++) {
                                String phone = mStr[i].split(":").length == 1 ? mStr[i].split(":")[0]
                                        : mStr[i].split(":")[1];
                                Cursor cursorPhone = mDbAdapter.getPhone(phone, 2);
                            ...
                            initTab2Data();
                            Toast.makeText(MessageActivity.this, R.string.add_contacts_success,
                                    Toast.LENGTH_SHORT).show();
                        }
                    }
